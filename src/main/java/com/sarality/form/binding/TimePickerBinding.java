 ...
 */
public class TimePickerBinding extends BaseViewBinding<EditText> {

  private TimePickerBinding(FormField field) {
    super(field);
  }
  ...
  public static class Factory implements ViewBindingFactory {
    ...
    public ViewBinding createBinding(FormField field) {
      return new TimePickerBinding(field);
    }
  }
}
